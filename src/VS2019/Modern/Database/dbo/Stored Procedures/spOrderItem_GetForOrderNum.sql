CREATE PROCEDURE [dbo].[spOrderItem_GetForOrderNum]
	@OrderNum int
AS
BEGIN
	SELECT   dbo.Orders.OrderNum, dbo.Items.ItemNum, dbo.Items.Description, dbo.Items.Amount, 
    ...
    WHERE     dbo.Orders.OrderNum = @OrderNum
END
